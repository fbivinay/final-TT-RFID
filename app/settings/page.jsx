      ...
      <div className="grid gap-6 lg:grid-cols-2">
        ...
        <section className="panel rounded-lg p-6">
          <div className="mb-4 flex items-center gap-3">
            <Settings size={18} className="text-signal-cyan" />
            <h2 className="text-sm font-black uppercase tracking-[0.18em] text-white">Current Session</h2>
          </div>
        ...
        <section className="panel rounded-lg p-6">
          <div className="mb-4 flex items-center gap-3">
            <Settings size={18} className="text-signal-cyan" />
            <h2 className="text-sm font-black uppercase tracking-[0.18em] text-white">System Information</h2>
          </div>
          <div className="space-y-3 text-sm">
        ...
        <section className="panel rounded-lg p-6">
          <div className="mb-4 flex items-center gap-3">
            <Settings size={18} className="text-signal-cyan" />
            <h2 className="text-sm font-black uppercase tracking-[0.18em] text-white">Database Tables</h2>
          </div>
          <div className="space-y-3 text-sm">
            {["inventory", "profiles", "racks", "alerts", "events", "movements", "simulation_config"].map((t) => (
              <div key={t} className="flex items-center justify-between border-b border-white/8 pb-2 last:border-0">
                ...
                <span className="rounded px-2 py-0.5 text-xs font-bold uppercase bg-signal-green/10 text-signal-green">Active</span>
              </div>
            ))}
          </div>
        </section>
        ...
        <section className="panel rounded-lg p-6">
          <div className="mb-4 flex items-center gap-3">
            <Settings size={18} className="text-signal-yellow" />
            <h2 className="text-sm font-black uppercase tracking-[0.18em] text-white">Admin Notes</h2>
          </div>
