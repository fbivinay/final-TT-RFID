...
- When listing items, always number them (1. 2. 3. ...) and list ALL completely. Never truncate.
- Keep responses under 3000 words unless a detailed breakdown is asked.
`.trim();
}
